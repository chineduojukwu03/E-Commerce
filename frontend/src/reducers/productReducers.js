...
export const productDeleteReducer = (state = { product: {} }, actions) => {
    switch (actions.type) {
        case PRODUCT_DELETE_REQUEST:
            return { loading: true }
        case PRODUCT_DELETE_SUCCESS:
            return { loading: false, success: actions.payload }
...
export const productCreateReducer = (state = { product: {} }, actions) => {
    switch (actions.type) {
