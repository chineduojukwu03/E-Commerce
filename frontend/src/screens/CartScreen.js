...
const CartScreen = ({ match, history, location }) => {
    ...
    return (
        <Row>
            <Col md={8}>
                <h1>Shopping Cart</h1>
                {cartItem.length === 0 ? <Message><Link to='/'>Go Back</Link></Message> : (
                ...
                <Card>
                    <ListGroup varinat='flush'>
                        <ListGroup.Item>
                            ...
                            {cartItems.reduc((acc, item) => acc + item.price, 0).toFixed(2)}
                        ...
                        <ListGroup.Item>
                            <Button type='button'
                                className='btn-block'
                                disabled={cartItem.length === 0} onClick={checkoutHandler}>
                                Process to checkout
                            </Button>
                        </ListGroup.Item>
                    </ListGroup>
